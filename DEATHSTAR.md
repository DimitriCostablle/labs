...
User = admin
Senha = hash MD5 do arquivo Star_Wars.pdf

<img width="570" height="406" alt="image" src="https://github.com/user-attachments/assets/6d082328-8edb-4199-87ba-fb03d7a35a55" />

 
Isso indicava que a senha do usuário admin poderia ser obtida gerando o hash MD5 do arquivo Star_Wars.pdf
...
O valor gerado foi utilizado como senha do usuário admin, permitindo acesso à aplicação web.
...
Descoberta da Senha do Usuário Darth
...
Foi utilizado o Hydra para testar as possíveis senhas do usuário darth.

<img width="886" height="217" alt="image" src="https://github.com/user-attachments/assets/d353c833-9050-4dd0-a12f-0eb37492995d" />

 
Comando utilizado:
hydra -l darth -P senha_darth.txt 192.168.56.202 http-post-form
Resultado obtido:
...
Login Millennium3000Falcon:
Usuário: kenobi
Senha: contém 7 dígitos
...
Ataque de Força Bruta no Usuário Kenobi
O arquivo gerado foi utilizado em um novo ataque com Hydra.
Comando utilizado:
hydra -l kenobi -P senhas_kenobi.txt 192.168.56.202 http-post-form
