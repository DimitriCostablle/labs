...
O servidor web não deve armazenar credenciais ou arquivos internos no diretório público. Informações sensíveis 

devem ser mantidas fora do diretório raiz do Apache e protegidas por permissões adequadas.A implementação de boas 

práticas de hardening reduz significativamente o risco de enumeração excessiva e exploração automatizada.
